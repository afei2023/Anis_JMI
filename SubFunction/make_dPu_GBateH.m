function dPu0=make_dPu_GBateH(Q_up, G_Beta, velocity, velocity_nmo, velocity_horizontal, ...
...
for iz=num_z:-1:1
    ...
    dpu = For_GH_operator(qu, velocity_at_depth, velocity_nmo_at_depth, velocity_horizontal_at_depth, ...
